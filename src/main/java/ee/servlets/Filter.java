 ...
 *         <filter-class>ee.servlets.Filter</filter-class>
 *         <init-param>
 *             <param-name>namespace</param-name>
 *             <!-- Это просто строка а не ссылка на Бин -->
 *             <param-value>ee.servlets.mvc.beans.Person</param-value>
 *         </init-param>
 *     </filter>
 *     <filter-mapping>
 *         <filter-name>Filter</filter-name>
...
public class Filter implements javax.servlet.Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        System.out.println("We use init from ee.servlets.Filter");
    ...
    @Override
    public void destroy() {
        System.out.println("We use destroy from ee.servlets.Filter");
    }
}
